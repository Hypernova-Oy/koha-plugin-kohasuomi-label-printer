package Koha::Plugin::Fi::KohaSuomi::LabelPrinter::OplibSheets::Sheet_6x1_1_2;
...
=head
    Koha::Plugin::Fi::KohaSuomi::LabelPrinter::OplibSheets::Sheet_6x1_1_2::create($labelsData, $filePathAndName, $debug);
